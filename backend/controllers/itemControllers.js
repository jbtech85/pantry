...
// prior mongo version for reference
// export const getGroceryOld = async (req, res) => {
//   const { household_id } = req.params;
...
export const getGrocery = async (req, res) => {
  ...
  const { data, status } = await poolQuery(`SELECT name, variation FROM pantry_item WHERE household_id = ${household_id} AND isGrocery = true`);
...
// prior mongo version for reference
// export const getPastItemsOld = async (req, res) => {
//   const { household_id } = req.params;
...
export const getPastItems = async (req, res) => {
  ...
  const { data, status } = await poolQuery(`SELECT name, variation FROM pantry_item WHERE household_id=${household_id} AND isPantry = false AND isGrocery = false`);
...
// prior mongo version for reference
// export const newItemOld = async (req, res) => {
//   const { household_id } = req.params;
...
// prior mongo version for reference
// export const updateItemOld = async (req, res) => {
...
export const updateItem = async (req, res) => {
  // TODO: write this controller in postgres
}

// prior mongo version for reference
// export const deleteItemsOld = async (req, res) => {
